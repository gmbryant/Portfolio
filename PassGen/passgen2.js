// Event listener for button click to generate password
document.getElementById("genButton").addEventListener("click", getCriteria)
...
function getCriteria() {
  ...
  document.getElementById("result").innerHTML = randomPassword(
    c1,
    c2,
    c3,
    c4,
